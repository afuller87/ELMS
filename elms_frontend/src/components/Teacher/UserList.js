      ...
      <div className="modal-body">
            ...
            <form>
                <div className="mb-3">
                    ...
                    <textarea onChange={grouphandleChange} value={groupMsgData.msg_text} name="msg_text" className='form-control' rows="15"></textarea>
                </div>
        ...
        <div className='row'>
            ...
            <div className='col-md-4 col-12'>
                ...
                <form>
                    <div className="mb-3">
                        <label for="exampleInputEmail1" className="form-label">Message</label>
                        <textarea onChange={handleChange} value={msgData.msg_text} name="msg_text" className='form-control' rows="15"></textarea>
                    </div>
